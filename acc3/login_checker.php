...
// if access level was not 'Manager', redirect him to login page
if(isset($_SESSION['access_level']) && $_SESSION['access_level']=="Manager"){
    header("Location: {$home_url}man/index.php?action=logged_in_as_man");
}
